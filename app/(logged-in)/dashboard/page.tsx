...
export default function Page() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container max-auto flex flex-col gap-4">
        <div className="px-2 py-12 sm:py-20">
          <div className="flex  gap-5 mb-8 justify-between">
          ...
          <div className="mb-6">
            <div className="bg-rose-100 border border-rose-200 rounded-lg p-4 text-rose-800 ">
            <p className="text-sm">You've reached the limit of {uploadLimit} upload on the Basic Plan.
